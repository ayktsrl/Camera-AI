...
export const EXERCISE_LIBRARY = [
  ...
  },
  {
    ...
    untrackableReason: "Sırtüstü/yere yatık poz; kalça açısı squat/lunge desenine yakın ama yatık supine pozda mevcut tracker eğitilmedi.",
  },
  {
    id: "pike-pushup",
    name: "Pike Push-Up",
  ...
  },
  {
    ...
    untrackableReason: "Sırtüstü yatık poz — FormCoach'un supine pozda güvenilir landmark'ı yok (lying makineler de bu yüzden rehberli).",
  },
  {
    id: "dips",
  ...
  },
  {
    ...
    untrackableReason: "Çok hızlı alternatif koşu deseni — knee-raise motoru tek tek kontrollü diz kaldırma için, yüksek tempoda sayım kaçar.",
  },
  {
    id: "arm-circles",
    name: "Arm Circles",
